...
import argparse
import torch
from utils.kari_roads_dataset import KariRoadsDataset
...
def train(opt):
    ...
    # Train dataset
    train_dataset = KariRoadsDataset('./data/kari_roads_mini', train=True)
    # Train dataloader
    ...
    # Validation dataset
    val_dataset = KariRoadsDataset('./data/kari_roads_mini', train=False)
